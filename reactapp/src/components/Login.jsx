...
export const Login = () => {
  ...
  const handleBackToHome = () => {
    navigate('/'); // Change this path to the appropriate route for LandingPage
  };
          ...
          <div className="col">
            ...
            <div className="m-3 pt-3">
              <form onSubmit={handleFormSubmit}>
                ...
                <div className="mb-3 text-start">
                  <label htmlFor="password" className="form-label position-relative start">
                    Password
                  </label>
                  <input
                    type="password"
                ...
                <button type="button" className="btn btn-primary m-3" onClick={handleBackToHome}>
                  Back
                </button>
              </form>
            </div>
